    ...
    constructor() {
        ...
        this.id = transformCallback(({ message, id }) => {
            ...
            if (id === tslib_es6.__classPrivateFieldGet(this, _Channel_nextMessageId, "f")) {
                tslib_es6.__classPrivateFieldSet(this, _Channel_nextMessageId, id + 1, "f");
                tslib_es6.__classPrivateFieldGet(this, _Channel_onmessage, "f").call(this, message);
                // process pending messages
                const pendingMessageIds = Object.keys(tslib_es6.__classPrivateFieldGet(this, _Channel_pendingMessages, "f"));
                if (pendingMessageIds.length > 0) {
                    ...
                    for (const pendingId of pendingMessageIds.sort()) {
                        ...
                        if (parseInt(pendingId) === nextId) {
                            ...
                            const message = tslib_es6.__classPrivateFieldGet(this, _Channel_pendingMessages, "f")[pendingId];
                            // eslint-disable-next-line security/detect-object-injection
                            delete tslib_es6.__classPrivateFieldGet(this, _Channel_pendingMessages, "f")[pendingId];
                            tslib_es6.__classPrivateFieldGet(this, _Channel_onmessage, "f").call(this, message);
                    ...
                    tslib_es6.__classPrivateFieldSet(this, _Channel_nextMessageId, nextId, "f");
                }
            }
            else {
                tslib_es6.__classPrivateFieldGet(this, _Channel_pendingMessages, "f")[id.toString()] = message;
            }
        });
    }
